...
const CustomForm = ({ item, onClose }: { item?: any; onClose: () => void }) => {
    ...
    const priorities = useMemo(() => {
        return Object.keys(TaskPriorityEnum).map((i: string) => ({
            value: i,
    ...
    const onSubmit = useCallback(() => {
        ...
        fn(url, {
            ...
            onError: () => {
                toast.error(`Task creation failed: ${errors.toString()}`, {
        ...
        >
            <>
                ...
                <ShadSelect
                    ...
                    onChange={(e: string) => setData('reporter_id', e)}
                    list={users}
                    errors={errors}
                />
                <ShadSelect
                ...
                <div className="flex justify-between gap-3">
                    ...
                    <ShadSelect
                        ...
                        name="priority"
                        value={data.priority}
                        onChange={(e: string) => setData('priority', e)}
                        list={priorities}
                        errors={errors}
                    />
                </div>
                ...
                <div className="flex justify-between gap-3">
                    <ShadInput
                        ...
                        onChange={(e) =>
                            setData('story_points', parseNumber(e.target.value))
                        }
                        errors={errors}
                    />
                    <ShadInput
                        ...
                        value={data.order}
                        onChange={(e) =>
                            setData('order', parseNumber(e.target.value))
                        }
                        errors={errors}
                    />
                </div>
                ...
                <div className="flex justify-between gap-3">
                    ...
                    <ShadInput
                        ...
                        onChange={(e) =>
                            setData('hours_spent', parseNumber(e.target.value))
                        }
                        errors={errors}
                    />
                </div>
