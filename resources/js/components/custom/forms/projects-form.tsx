...
import type { TProjectStatus } from '@/types/models/project';
...
const CustomForm = ({ item, onClose }: { item?: any; onClose: () => void }) => {
    ...
    const statuses = useMemo(() => {
        return Object.keys(ProjectStatusEnum).map((i: string) => ({
            value: i,
        ...
        >
            <>
                ...
                <ShadSelect
                    ...
                    name="team_id"
                    value={data.team_id}
                    onChange={(e: string) => setData('team_id', e)}
                    list={teams}
                    errors={errors}
                />
                <ShadSelect
                    ...
                    value={data.github_repository_id}
                    onChange={(e: string) => setData('github_repository_id', e)}
